    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_level', models.CharField(blank=True, max_length=20)),
                ('address', models.CharField(blank=True, max_length=60)),
                ('next_time', models.DateField()),
                ('clue_source', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='crm.ClueSource')),
